            ...
            <div style={styles.statsRow}>
              <div style={styles.statBox}>
                ...
                <span style={styles.statLabel}>
                  <span style={styles.statIcon}>👥</span> Seguidores
                </span>
              </div>
              <div style={styles.statBox}>
                <span style={styles.statValue}>{user.plan}</span>
                <span style={styles.statLabel}>
                  <span style={styles.statIcon}>⭐</span> Plano
                </span>
              </div>
            </div>
          </div>
            ...
            {tracks.length === 0 ? (
              ...
              tracks.map((track, i) => (
                <div
                  ...
                  style={{
                    ...styles.trackRow,
                    ...(hoveredTrack === i ? styles.trackRowHover : {}),
                  }}
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      ...
      <button
        ...
        title={error ? "Preview indisponível" : playing ? "Pausar" : "Ouvir preview"}
      >
...
const styles: Record<string, React.CSSProperties> = {
  ...
  bgGradient: {
    ...
    right: 0,
    bottom: 0,
    background: "radial-gradient(circle at 20% 50%, rgba(29,185,84,0.08) 0%, transparent 50%)",
    pointerEvents: "none",
    zIndex: 0,
  },
  header: {
  ...
  banner: {
    height: 100,
    background: "linear-gradient(135deg, #1DB954 0%, #0a3d1c 50%, #0a0a0a 100%)",
    position: "relative",
  },
  bannerOverlay: {
    position: "absolute",
  ...
  avatarPlaceholder: {
    ...
    borderRadius: "50%",
    border: "4px solid #1a1a1a",
    background: "linear-gradient(135deg, #1DB954 0%, #0a3d1c 100%)",
    display: "flex",
    alignItems: "center",
  ...
  barSmall: {
    display: "block",
    width: 3,
    background: "linear-gradient(180deg, #1DB954 0%, #0a3d1c 100%)",
    borderRadius: 2,
    opacity: 0.8,
